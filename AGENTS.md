...
| 条目已写入，**整包待目标环境验证** | `web_multi_tabs` `19.0.2.0.0`、`product_variant` `19.0.7.0.0` | 升级后需在中文「应用」列表里核对标题 / 摘要 / 描述 / 分类 |
