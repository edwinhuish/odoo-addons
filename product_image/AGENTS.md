...
- 当前版本：`19.0.2.3.0`（管理弹窗拖动排序 / 删除确认 / 批量删除；`19.0.2.2.10~2.2.15` 布局与弹窗改动同批待验证）
